...
To alleviate this, we employ a No U-Turn Sampler (NUTS) \cite{homan14} powered by MOP-$\alpha$, with a nonparametric empirical prior constructed from density estimation of the parameter swarm from the IF2 warm-start. 
