...
This is a strong law of large numbers for triangular arrays of particles resampled arbitrarily, with resampling probabilities not proportion to the targeted distribution of interest, to weights that correct for the cumulative discrepancy between the resampling and the target distribution.
