...
It provides an unbiased estimate of the likelihood function  \cite{delmoral2004feynman}, enabling Bayesian inference \cite{doucet2010pmcmc,chopin13} and maximum likelihood inference \citep{ionides06,ionides15}.
...
Some plug-and-play methods depend on the construction of low-dimensional summary statistics \cite{wood2010sl,welch2009abc}, sacrificing statistical efficiency for computational convenience.
