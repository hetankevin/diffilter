...
Our approach has similarities with \cite{svensson18}, who reweight particles from a previous run at $\phi$ to evaluate the likelihood at any sufficiently nearby parameter $\theta$ for $0$-th order optimization.
