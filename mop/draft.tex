...
\end{equation}
as we have a telescoping product.
...
\paragraph{Bias-Variance Tradeoff} This discounting serves the purpose of balancing a tradeoff between maintaining memory of the entire trajectory, or 
...
\begin{prop}[Correctness of DOP-$\alpha$ (Algorithm \ref{alg:dop})]
    ...
    Algorithm \ref{alg:dop} is a properly weighted particle filter that is unbiased for the likelihood, for all $\alpha$. 
